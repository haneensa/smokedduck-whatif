...
class TestKSemimodule(object):
    def test_ksemimodule(self):
        ...
        df = con.execute('select ksemi1.b, sum(ksemi1.a + ksemi2.c) from ksemi1 join ksemi2 on ksemi1.b = ksemi2.b group by ksemi1.b', capture_lineage='ksemimodule')
        print(df)
        ...
        print(con.execute(
            ...
            where contains(lower(table_name), 'lineage')
